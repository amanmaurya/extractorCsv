   ...
   createCSV: function(req, res, next) {
    ...
    requestPromise(getTokenConfig)
      ...
      .then(function(data){
        ...
        getStoreDistributor.json={
           
        };
        getStoreDistributor.json.startDate=req.query.startdate || "2018-03-14";
        getStoreDistributor.json.endDate=req.query.enddate || "2018-03-14";
        return requestPromise(getStoreDistributor);
